    ...
    return (
        <div className='box-border rounded-2xl max-w-xl mx-auto shadow bg-gray-50 dark:bg-slate-800 sm:mt-10 mb-4 sm:mb-6 p-3'>
            ...
            <div className='text-lg text-center'>
                <div className='text-blue-900 font-bold inline dark:text-blue-100'>
                    Malik Idrees
                </div>
            </div>
            <div className='text-blue-600 text-sm text-center my-2 dark:text-blue-100'>@midrs</div>
            <div className='flex justify-between max-w-sm mx-auto border-t border-gray-200 dark:border-gray-600 mt-3 p-3 text-center'>
                ...
                <div>
                    <p className='text-very-dark-desaturated-blue font-bold text-lg'>Goal</p>
